...
export function OrderPanel({
  ...
  return (
    <div className="w-100 max-w-full shrink-0 border-l border-rule bg-card flex flex-col overflow-hidden">
      ...
      {selectedItem ? (
        ...
        <>
          ...
          <ScrollArea className="flex-1 min-h-0">
            {cart.length === 0 ? (
              <EmptyState icon={ShoppingCart} title="No items in this order" description="Choose an item from the menu to start the order." />
            ) : (
