...
import { WorkspaceRecommendation } from '@/components/settings/workspaces/WorkspaceRecommendation';
...
export function WorkspaceComposition() {
  ...
  return (
    <SettingsSection
      title="Workspace plan and readiness"
      description="Describe how the business runs, review DUMA's module proposal, then work through the live prerequisites for service. Nothing activates silently or gets checked off by hand."
    ...
    >
      {!tenantId ? (
        ...
        <div>
          ...
          <div className="mt-6 grid gap-6 lg:grid-cols-[minmax(0,1fr)_minmax(16rem,0.55fr)]">
